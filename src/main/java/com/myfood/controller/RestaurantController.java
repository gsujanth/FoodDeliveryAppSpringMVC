...
public class RestaurantController {
	...
	public ModelAndView getCustomerData(@RequestParam(value = "zipCode") int pincodeFromForm, HttpSession session) {
		...
		/*
		 * if(pincodeFromForm != null) pincode = Integer.parseInt(pincodeFromForm);
		 */
	...
	public ModelAndView viewAndDeleteRestaurant(HttpSession session, @PathVariable("restaurantId") int id,
	...
	public ModelAndView registerRestaurant(HttpSession session, @ModelAttribute("restaurant") Restaurant restaurant,
			final RedirectAttributes redirectAttributes) {
		if (session.getAttribute("customerId") != null && session.getAttribute("userRole") != null
				&& session.getAttribute("userRole").toString().equalsIgnoreCase("admin")) {
			System.out.println("restaurantService.getRestaurantByName(restaurant.getRestaurantName())--"
