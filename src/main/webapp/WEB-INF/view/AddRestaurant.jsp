...
<body>
	...
	<form:form name="myform" action="${userActionUrl}" method="POST"
		modelAttribute="restaurant" class="form-horizontal"
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<form:input path="pincode" type="number" class="form-control"
					name="pincode" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<form:input path="cuisine" type="text" class="form-control"
					name="cuisine" />
			</div>
		</div>
		<div class="form-group">
