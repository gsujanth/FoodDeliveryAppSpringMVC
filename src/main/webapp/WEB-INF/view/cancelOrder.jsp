...
<body style="height: 100%; width: 100%; min-height: 0px;">
	<h1 style="text-align: center;"><font color="Red">Order cancelled</font></h1>
	<c:url value="/viewOrders" var="userActionUrl" />
<form:form id="myForm" action="/view/viewOrders" method="POST"
		...
		<div id="container" style="width: 100%; height: 100%;float:left;">
			<div id="container-top" style="width: 100%; height: 100%;float:left;">
				<div id="container-top-left"
					...
					<tr><td width="389" align="left" valign="top" style="padding-left: 60px; padding-right: 10px;font-family:Arial; font-size: 16px;"><p><font color="magenta"><b>Reason: ${comments}</b></font></p></td></tr>
					</table>
